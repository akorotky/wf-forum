...
public interface PostRepository extends ReactiveCrudRepository<Post, Long> {
    ...
    @Query("SELECT * FROM post WHERE thread_id=:threadId LIMIT :#{#pageable.pageSize} OFFSET :#{#pageable.offset}")
    Flux<Post> findByThreadId(Long threadId, Pageable pageable);
}
